    ...
    <>
      ...
      >
        <h2 className="text-xl font-bold">
          {selected === "fn" ? "First Name" : "Last Name"}
        </h2>
        ...
        <button
          className="bg-white text-brand.green border mt-3 text-lg rounded-lg p-2"
      ...
      >
        <div className="flex flex-col p-4">
            ...
            <div className="flex flex-col p-4">
              ...
              <div className="flex flex-col space-y-4 mx-auto">
                {sexualities.map((sexuality) => (
                  <div key={sexuality} className="border-b-gray-400"></div>
                ))}
              </div>
            </div>
          </div>
          ...
          <button className="bg-brand.green text-white mt-10 text-xl rounded-lg p-2">
            Update Profile
          </button>
        </div>
      </CommonScreen>
